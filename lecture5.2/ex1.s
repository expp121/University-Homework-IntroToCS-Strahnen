...
_start:
	...
	ldhu r2, (r2)	# gets the value stored at the memory address of B
	
	movia r3, C	# loads the memory address of variable C into R3
	ldhu r3, (r3)	# gets the value stored at the memory address of C
	
	add r2,r2,r3	# adds r2 and r3 and saves it in r2 -> r2 = r2 + r3 ( r2 = B + C)
	
	movia r3, A	# loads the memory address of variable A into R3
	ldhu r3, (r3)	# gets the value stored at the memory address of A
	
	sub r2, r2, r3	# subtracts r2 and r3, and saves it in r2 -> r2 = r2 - r3 (r2 = (B + C) - A)
